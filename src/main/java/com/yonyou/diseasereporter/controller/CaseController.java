package com.yonyou.casereporter.controller;
...
public class CaseController {
    ...
    public Map<String, Object> addCase(@RequestBody(required = false) Case case){
        //登录 权限控制
        ...
        resultMap.put("date", caseService.addCase(case));
        return resultMap;
    }
